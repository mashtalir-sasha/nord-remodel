...
$(function () {
  var toggle = document.querySelector('.nav-mob__btn');
  ...
  var toggleAdd = document.querySelector('.open-additional');
  var navAdd = document.querySelectorAll('.additional-menu');
  toggleAdd.addEventListener('click', function (e) {
    this.classList.toggle('open');

    var _iterator = _createForOfIteratorHelper(navAdd),
        _step;
